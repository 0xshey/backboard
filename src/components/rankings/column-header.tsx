	...
	return (
		<div
			className={cn(
				...
				"cursor-pointer text-[10px] md:text-xs font-sans text-medium border hover:bg-muted/50 hover:border-border rounded-md text-muted-foreground backdrop-blur-sm",
