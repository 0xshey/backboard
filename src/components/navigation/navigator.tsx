	...
	return (
		...
		>
			<motion.div
				...
				className="pointer-events-auto relative flex flex-col items-center gap-1 p-1 rounded-xl bg-muted backdrop-blur-sm border border-border shadow-md h-fit w-full md:w-fit md:min-w-120 mx-auto overflow-hidden"
